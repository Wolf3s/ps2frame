...
#define GS_PMODE        				((volatile unsigned int*)0x12000000)
#define GS_SMODE2       				((volatile unsigned int*)0x12000020)
#define GS_DISPFB1      				((volatile unsigned int*)0x12000070)
#define GS_DISPLAY1     				((volatile unsigned int*)0x12000080)
#define GS_DISPFB2      				((volatile unsigned int*)0x12000090)
#define GS_DISPLAY2     				((volatile unsigned int*)0x120000a0)
#define GS_EXTBUF       				((volatile unsigned int*)0x120000b0)
#define GS_EXTDATA      				((volatile unsigned int*)0x120000c0)
#define GS_EXTWRITE     				((volatile unsigned int*)0x120000d0)
#define GS_BGCOLOR      				((volatile unsigned int*)0x120000e0)
#define GS_CSR          				((volatile unsigned int*)0x12001000)
#define GS_IMR          				((volatile unsigned int*)0x12001010)
#define GS_BUSDIR       				((volatile unsigned int*)0x12001040)
#define GS_SIGID        				((volatile unsigned int*)0x12001080)
#define GS_LABELID      				((volatile unsigned int*)0x12001090)
...
#define GS_SET_DISPLAY(dx, dy, magh, magv, ddw, ddh ) \
	((long)(dx) | ((long)(dy)<<12) | ((long)(magh) << 23) |  \
	((long)(magv)<<27) | ((long)(ddw)<<32)  | ((long)(ddh)<<44) )


#define GS_SET_FRAME_1(base, width, format, mask ) \
	((long)(base)) | ((long)(width) << 16) | ((long)(format)<<24) | ((long)(mask)<<32)


#define	GS_SET_ZBUF_1(base, format,  mask) \
	((long)(base)) | ((long)(format)<<24) | ((long)(mask)<<32)

#define	GS_SET_XYOFFSET_1(offx, offy )			((long)(offx)) | ((long)(offy)<<32)

#define GS_SET_CLIP_1(x1, y1, x2, y2 ) \
	((long)(x1)) | ((long)(y1) << 32) | ((long)(x2)<<16) | ((long)(y2)<<48)
...
#define GS_SET_ALPHA(alpha1, alpha2, alpha3, alpha4, alpha5 ) \
	((long)(alpha1) | ((long)(alpha1)<<2) | ((long)(alpha3) << 4) |  \
	((long)(alpha4)<<6) | ((long)(alpha5) << 32) )

#define	GS_SET_FBA( alpha )					((long)(alpha))


#define GS_SET_TEST( onoff, mode, check, failcheck, destonoff, destmode, ztest, ztestmode )	 \
	((long)(onoff) | ((long)(mode)<<1) | ((long)(check) << 4) |  \
	((long)(failcheck)<<12) | ((long)(destonoff)<<14)  | ((long)(destmode)<<15) | ((long)(ztest)<<16) | ((long)(ztestmode)<<16))



#define GS_SET_BITBLTBUF( source, swidth, sformat, dest, dwidth, dformat) \
	((long)(source) | ((long)(swidth)<<16) | ((long)(sformat) << 24) |  \
	((long)(dest)<<32) | ((long)(dwidth) << 48) | ((long)(dformat) << 56) ) 


#define GS_SET_TRXPOS( srcx, srcy, dstx, dsty, dir ) \
	((long)(srcx) | ((long)(srcy)<<16) | ((long)(dstx) << 32) |  \
	((long)(dsty)<<48) | ((long)(dir) << 59) ) 

#define GS_SET_TRXREG( w, h ) 		( (long)(w) | ((long)(h)<<32) )

#define GS_SET_TRXDIR( d ) 		( (long)(d) )

#define GS_SET_CLAMP( wh, wv, minu, maxu, minv, maxv) \
	((long)(wh) | ((long)(wv)<<2) | ((long)(minu) << 4) |  \
	((long)(maxu)<<14) | ((long)(minv) << 24) | ((long)(maxv) << 34) ) 

#define GS_SET_TEX0( tbase, tbuffw, tformat, tw, th, tc, tf, clut, clutformat, clutstore, clutoff, clutbl) \
	(	(long)(tbase) 			| ((long)(tbuffw)<<14) 	| ((long)(tformat) << 20) |  \
		((long)(tw)<<26) 		| ((long)(th) << 30) 	| ((long)(tc) << 34)  | \
		((long)(tf)<<35) 		| ((long)(clut) << 37) 	| ((long)(clutformat) << 51) | ((long)(clutstore)<<55) | \
		((long)(clutoff)<<56) 	| ((long)(clutbl) << 61) ) 

#define GS_SET_TEX1(mipcalc, maxmip, expfilter, shrinkfilt, mipbase, mipl, mipk ) \
	((long)(mipcalc) | ((long)(maxmip)<<2) | ((long)(expfilter) << 5) |  \
	((long)(shrinkfilt)<<8) | ((long)(mipbase)<<9)  | ((long)(mipl)<<15) | ((long)(mipk)<<32) )
